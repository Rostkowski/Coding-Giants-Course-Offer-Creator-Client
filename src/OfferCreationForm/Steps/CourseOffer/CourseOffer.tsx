...
const CourseOffer: React.FC<ICourseOffer> = (props) => {
  ...
  useEffect(() => {
    props.selectedCourse.forEach((course) => {
      fetch(
        `http://srv09.mikr.us:40118/https://giganciprogramowaniaformularz.edu.pl/api/Course/courses/${course.value}`,
        {
          method: "GET",
          headers: {
      ...
      fetch(
        `http://srv09.mikr.us:40118/https://giganciprogramowaniaformularz.edu.pl/api/Timetable/${
